...
https://github.com/Err0rCode7/capstone_project
...
개발 중간중간 버그 픽스와 예외 처리 등..

1. 친구 (팔로우, 팔로윙), 캡슐 좋아요, 댓글과 답글, 캡슐 필터 api
2. 세션, 로그아웃, 잠금기능
3. aws에 Docker, nodejs, mysql 올리기 ui-ux 작업